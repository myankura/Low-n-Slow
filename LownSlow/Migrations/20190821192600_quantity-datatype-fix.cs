...
{
    public partial class quantitydatatypefix : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "00000000-ffff-ffff-ffff-ffffffffffff", 0, "5989f349-c764-41aa-9783-9b17aeb12192", "admin@admin.com", true, "admin", "admin", false, null, "ADMIN@ADMIN.COM", "ADMIN@ADMIN.COM", "AQAAAAEAACcQAAAAEPv1ULv2jW6X/l1AV1qmoivnzW4B4O1sB2jIkc0UYmpQ7PXNxbQ+O6NfwQ/OYN/Mig==", null, false, "7f434309-a4d9-48e9-9ebb-8803db794577", false, "admin@admin.com" },
                    { "11111111-ffff-ffff-ffff-ffffffffffff", 0, "25a25807-162d-4096-bd35-b2fff36c5f4d", "michael@me.com", true, "Michael", "Yankura", false, null, "MICHAEL@ME.COM", "MICHAEL@GMAIL.COM", "AQAAAAEAACcQAAAAEMkRXVxl2gnxO1vbYb/xq6sma+jDpK+PF5CxTha4rRfNJJIeBgr0blFiolwQqbj2nQ==", null, false, "j4k6l3k0-d87f-98eh-10kk-2285db796699", false, "michael@gmail.com" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                {
                    { 1, null, 1, "tsp", 10.0, 1 },
                    { 28, null, 15, "Tbsp", 10.0, 4 },
                    { 27, null, 14, "Tbsp", 6.0, 4 },
                    { 26, null, 12, "tsp", 10.0, 4 },
                    { 25, null, 11, "Tbsp", 5.0, 4 },
                    { 24, null, 10, "tsp", 10.0, 4 },
                    { 15, null, 9, "lbs", 10.0, 2 },
                    { 14, null, 7, "tsp", 10.0, 2 },
                    { 13, null, 6, "Tbsp", 10.0, 2 },
                    { 12, null, 5, "Tbsp", 6.0, 2 },
                    { 11, null, 3, "tsp", 10.0, 2 },
                    { 10, null, 2, "Tbsp", 5.0, 2 },
                    { 9, null, 1, "tsp", 10.0, 2 },
                    { 23, null, 17, "lbs", 1.0, 3 },
                    { 22, null, 16, "tsp", 10.0, 3 },
                    { 21, null, 15, "Tbsp", 10.0, 3 },
                    { 20, null, 14, "Tbsp", 6.0, 3 },
                    { 19, null, 13, "tsp", 5.0, 3 },
                    { 18, null, 12, "tsp", 10.0, 3 },
                    { 17, null, 11, "Tbsp", 5.0, 3 },
                    { 16, null, 10, "tsp", 10.0, 3 },
                    { 8, null, 8, "lbs", 1.0, 1 },
                    { 7, null, 7, "tsp", 10.0, 1 },
                    { 6, null, 6, "Tbsp", 10.0, 1 },
                    { 5, null, 5, "Tbsp", 6.0, 1 },
                    { 4, null, 4, "tsp", 5.0, 1 },
                    { 3, null, 3, "tsp", 10.0, 1 },
                    { 2, null, 2, "Tbsp", 5.0, 1 },
                    { 29, null, 16, "tsp", 10.0, 4 },
                    { 30, null, 18, "lbs", 1.0, 4 }
                });
